...
namespace Illuminate\Testing {
     ...
     */        class TestResponse {
         ...
         * 
         *
         * @see \App\Providers\JsonApiServiceProvider::boot()
         * @param mixed $attribute
         * @static 
         */        public static function assertJsonApiValidationErrors($attribute)
        {
                        return \Illuminate\Testing\TestResponse::assertJsonApiValidationErrors($attribute);
        }
                    /**
         * 
         *
         ...
         * @param mixed $self
         * @static 
         */        public static function assertJsonApiResource($model, $attributes, $self = null)
        {
                        return \Illuminate\Testing\TestResponse::assertJsonApiResource($model, $attributes, $self);
        }
                    /**
         * 
         *
         ...
         * @static 
         */        public static function assertJsonApiResourceCollection($models, $attributeKeys)
        {
                        return \Illuminate\Testing\TestResponse::assertJsonApiResourceCollection($models, $attributeKeys);
        }
                    /**
         * 
         *
         ...
         * @static 
         */        public static function assertJsonApiRelationshipLinks($model, $relations)
        {
                        return \Illuminate\Testing\TestResponse::assertJsonApiRelationshipLinks($model, $relations);
        }
                    /**
         * 
         *
         ...
         * @param array $relations
         * @static 
         */        public static function assertJsonApiCollectionRelationshipLinks($models, $relations)
        {
                        return \Illuminate\Testing\TestResponse::assertJsonApiCollectionRelationshipLinks($models, $relations);
        }
                    /**
         * 
         *
         ...
         * @static 
         */        public static function assertJsonApiError($title = null, $detail = null, $status = null)
        {
                        return \Illuminate\Testing\TestResponse::assertJsonApiError($title, $detail, $status);
        }
            }
    }
...
namespace  {
             ...
             *
             * @see \App\Providers\JsonApiServiceProvider::boot()
             * @param array $allowedFilterFields
             * @static 
             */            public static function allowedFilters($allowedFilterFields)
            {
                                return \Illuminate\Database\Eloquent\Builder::allowedFilters($allowedFilterFields);
            }
                            /**
             * 
             *
             ...
             * @static 
             */            public static function allowedSorts($allowedSortFields)
            {
                                return \Illuminate\Database\Eloquent\Builder::allowedSorts($allowedSortFields);
            }
                            /**
             * 
             *
             ...
             * @static 
             */            public static function allowedIncludes($allowedIncludes)
            {
                                return \Illuminate\Database\Eloquent\Builder::allowedIncludes($allowedIncludes);
            }
                            /**
             * 
             *
             * @see \App\Providers\JsonApiServiceProvider::boot()
             * @static 
             */            public static function sparseFieldset()
            {
                                return \Illuminate\Database\Eloquent\Builder::sparseFieldset();
            }
                            /**
             * 
             *
            ...
            {
                                return \Illuminate\Database\Eloquent\Builder::getResourceType();
            }
                            /**
             * 
             *
             ...
             * @param mixed $page
             * @static 
             */            public static function jsonApiPaginate($perPage = 15, $page = 1)
            {
                                return \Illuminate\Database\Eloquent\Builder::jsonApiPaginate($perPage, $page);
            }
                            /**
