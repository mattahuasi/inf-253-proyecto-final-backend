...
class PaginateCategoriesTest extends TestCase
{
    ...
    #[Test]
    public function can_paginate_categories(): void
    {
    ...
    #[Test]
    public function can_paginate_sorted_categories(): void
    {
        $this->authenticateUser(['category:index']);
    ...
    #[Test]
    public function can_paginate_filtered_categories(): void
    {
        $this->authenticateUser(['category:index']);

        Category::factory()->create(['name' => 'B name test']);
        Category::factory()->create(['name' => 'C name']);
        Category::factory()->create(['name' => 'A name test']);
